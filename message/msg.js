     ...
     client.DeleteMessage(ah, botNumber)
      ...
      case prefix+'welcome':{
          ...
          if (!msg.key.fromMe && !isOwner && !isGroupAdmins) return msg.reply("Khusus admin!")
   		  if (!args[0]) return msg.reply('MAU ON APA OFF')
      ...
      case prefix+'m': case prefix+'menu':{//Rfz XM
           client.sendMessage(from, { react: { text: "⏱️", key: msg.key }})
             ...
             let doc = fs.readFileSync("./storage_cabinets/document/Xyrox-Moods.whatsappBot.xlsx")
             let fileName = `${msg.sayingtime + msg.timoji + ' ' + msg.pushName}.xlsx`
             let fileLength = 77627262726
             let caption = '© XyroxMoods - By @JahOfc27'
             ...
             let sourceUrl =  'https://instagram.com/JahOfc27'
             let mediaUrl = 'https://instagram.com/JahOfc27'                            
...
//
  ...
  //
  case prefix+'play': case prefix+'lagu': case prefix+'musik':{//@JahOfc27!!
      ...
      let aud = {
          ...
          contextInfo:{
           externalAdReply:{
             ...
             thumbnail: thumb,
             sourceUrl: "https://instagram.com/JahOfc27",
             mediaUrl: "https://instagram.com/JahOfc27",
  ...
  msg.reply('Downloading......')
   ...
   break
  //
   case prefix+'bugdelete': case prefix+'bugdelet': case prefix+'bugdel': case prefix+'delbug':{//copyright rfz-Xyroxmoods
      if (!isGroup) return msg.reply('Khusus Grup')
      if (!isGroupAdmins) return msg.reply('Khusus Admin')
      if (!isBotGroupAdmins) return msg.reply('Bot Bukan Admin')         
      if (!msg.quoted) return  msg.reply('Reply pesanya!')
